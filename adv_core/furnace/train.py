...
from adv_core.utils.context import ctx_noparamgrad_and_eval
from adv_core.utils.utils import seed

from adv_core.losses.mart import mart_loss
from adv_core.losses.rst import CosineLR
...
class Trainer(object):
    ...
    def init_scheduler(self, num_epochs):   # change the epochs into steps instead of epoch
        """
        ...
        elif self.params.scheduler == 'step':  # Data Augmentation can improve claimed that they use step lr intead.
            self.scheduler = torch.optim.lr_scheduler.MultiStepLR(self.optimizer, gamma=0.1, milestones=[int(num_epochs//3) * 2])
